(() => {
  ...
  const S = {
    ...
    'magnifying-glass':'<circle cx="11" cy="11" r="6.5"/><path d="m16 16 4 4"/>',
    'x-circle':'<circle cx="12" cy="12" r="8.5"/><path d="m9 9 6 6M15 9l-6 6"/>',
    'dots-three':'<circle cx="6" cy="12" r="1.3" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r="1.3" fill="currentColor" stroke="none"/><circle cx="18" cy="12" r="1.3" fill="currentColor" stroke="none"/>',
    'copy':'<rect x="8" y="8" width="11" height="11" rx="2"/><path d="M16 8V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h2"/>',
    'users-three':'<circle cx="9" cy="9" r="3"/><path d="M3.5 19c.7-3.1 2.5-4.8 5.5-4.8s4.8 1.7 5.5 4.8M15.5 6.5a2.8 2.8 0 0 1 0 5.4M16.2 14.4c2.3.2 3.7 1.7 4.3 4.1"/>',
    'list-bullets':'<circle cx="5" cy="6" r="1" fill="currentColor" stroke="none"/><circle cx="5" cy="12" r="1" fill="currentColor" stroke="none"/><circle cx="5" cy="18" r="1" fill="currentColor" stroke="none"/><path d="M9 6h11M9 12h11M9 18h11"/>',
    'calendar-blank':'<rect x="3.5" y="5.5" width="17" height="15" rx="2"/><path d="M8 3.5v4M16 3.5v4M3.5 10h17"/>',
    ...
    'info':'<circle cx="12" cy="12" r="8.5"/><circle cx="12" cy="8" r=".8" fill="currentColor" stroke="none"/><path d="M12 11v5"/>',
    'sign-out':'<path d="M10 5H5v14h5M14 8l4 4-4 4M8 12h10"/>',
    'user-plus':'<circle cx="9" cy="8" r="3.5"/><path d="M3.5 19c.8-3.2 2.6-5 5.5-5s4.7 1.8 5.5 5M18 8v6M15 11h6"/>',
